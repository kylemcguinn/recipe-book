<template>
    <a href="#" class="group relative block w-52 h-60">
		...
		c2.283,0,4.134-1.867,4.133-4.15C45.399,20.425,43.548,18.557,41.267,18.557z" />
                ...
                <h2 class="mt-4 text-xl font-medium sm:text-2xl">Add Recipe</h2>
            </div>

            <div
                class="absolute p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
                <h3 class="mt-4 text-xl font-medium sm:text-2xl">Add Recipe</h3>

                <p class="mt-4 text-sm sm:text-base">
                    Import from a URL or manually add a new recipe
                </p>
            </div>
        </div>
    </a>
