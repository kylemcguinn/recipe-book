...
<template>
  <div
    class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md absolute z-50 top-12 -translate-x-1/2 left-1/2 w-96 transition-opacity ease-in duration-700"
