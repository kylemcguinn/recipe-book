...
<template>
    <div class="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8 absolute z-50 top-32 -translate-x-1/2 left-1/2 w-[calc(100%-2rem)] sm:w-auto"
        role="alert">
