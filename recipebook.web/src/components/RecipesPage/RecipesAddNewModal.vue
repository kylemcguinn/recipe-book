...
<template>
    <div class="rounded-2xl border border-blue-100 bg-white p-4 shadow-lg sm:p-6 lg:p-8 fixed z-50 top-1/2 -translate-y-1/2 -translate-x-1/2 left-1/2 w-[calc(100%-2rem)] sm:w-auto"
        role="alert">
        <div class="flex items-center gap-4">
            <span class="shrink-0 rounded-full bg-blue-400 p-2 text-white">
                <svg fill="#ffffff" class="h-8 w-8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="font-medium sm:text-lg">Add a recipe!</p>
        </div>
